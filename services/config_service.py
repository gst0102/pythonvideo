...
DEFAULT_CONFIGS: Dict[str, Dict[str, Any]] = {
    ...
    "netdisk_public_visibility_config": {
        ...
        "note": "审核期默认关闭影视剧展示；小程序公开接口只展示安全分类，H5 独立承接轻量详情。",
    },
    "netdisk_frontend_categories_config": {
        "categories": [
            "AI工具",
            "办公资料",
            "自媒体素材",
    ...
    "netdisk_official_transfer_config": {
        "enabled": True,
        "settlement_mode": "record_only",
        "default_level1_amount": 0.20,
        "default_level2_amount": 0.05,
        "pan_rules": {
            "百度": {"level1_amount": 0.20, "level2_amount": 0.05, "enabled": True},
            "夸克": {"level1_amount": 0.20, "level2_amount": 0.05, "enabled": True},
            "UC": {"level1_amount": 0.20, "level2_amount": 0.05, "enabled": False},
            "迅雷": {"level1_amount": 0.20, "level2_amount": 0.05, "enabled": False},
            "快兔": {"level1_amount": 0.20, "level2_amount": 0.05, "enabled": False},
        },
